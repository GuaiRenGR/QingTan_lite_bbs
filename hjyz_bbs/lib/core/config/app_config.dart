...
class AppConfig {
  ...
  /// 默认服务器入口（单服务器兼容）
  static const String apiEntry = 'https://newbbs.hj1bbs.top/index.php';
  ...
  static const List<ServerConfig> serverList = [
    ServerConfig(
      id: 1,
      name: '主服务器',
      url: 'https://newbbs.hj1bbs.top/index.php',
      weight: 10,
    ),
  ];
  ...
  /// 下载页基础地址
  static const String downloadBase = 'https://newbbs.hj1bbs.top/download.php';
}
